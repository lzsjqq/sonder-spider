package com.snow.tiger.ip.proxy.processer;
...
public class KuaidailiProcessor implements PageProcessor {
    ...
    private static String url = "https://www.kuaidaili.com/free/inha/1/";
    ...
    public static void main(String[] args) {
        ...
        Spider.create(new KuaidailiProcessor()) // 实例化spider
...
//                .setDownloader(getProxyDownload("127.0.0.1", "8118"))
    ...
    public void process(Page page) {
        ...
        ///div/div/div
        List<Selectable> hosts = html.xpath("//table[@class='table table-bordered table-striped']/tbody/tr/td[1]/text()").nodes();
        List<Selectable> ports = html.xpath("//table[@class='table table-bordered table-striped']/tbody/tr/td[2]/text()").nodes();
        List<Selectable> anonymitys = html.xpath("//table[@class='table table-bordered table-striped']/tbody/tr/td[3]/text()").nodes();
...
//        // 部分三： 从页面发现后续的url地址来抓取
        ...
        page.addTargetRequests(links.regex("https://www.kuaidaili.com/free/inha/\\d+/").all());
    }
