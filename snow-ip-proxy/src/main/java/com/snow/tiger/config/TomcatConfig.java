...
public class TomcatConfig {
    ...
    public ServletWebServerFactory servletContainer() {
        ...
        tomcat.addConnectorCustomizers(new IpTomcatConnectionCustomizer());
        return tomcat;
    }
     ...
     * 默认http连接
     */
    public class IpTomcatConnectionCustomizer implements TomcatConnectorCustomizer {
        public IpTomcatConnectionCustomizer() {
        }
